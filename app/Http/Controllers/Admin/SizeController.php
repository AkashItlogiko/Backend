...
class SizeController extends Controller
{
    ...
    public function store(AddSizeRequest $request)
    {
        if($request->validated())
        {
           ...
           return redirect()->route('admin.sizes.index')->with(['success' =>'Size has been added successfully'
        ]);
        }
    }
    ...
    public function destroy(Size $size)
    {
        //
           $size->delete();
           return redirect()->route('admin.sizes.index')->with(['success' =>'Size has been deleted successfully'
        ]);
